...
def save_dc_fp_data(model: QuantModel, layer: QuantModule, cali_data: torch.Tensor,
...
def save_inp_oup_data(model: QuantModel, layer: QuantModule, cali_data: torch.Tensor,
                      batch_size: int = 32, keep_gpu: bool = True,
                      input_prob: bool = False):
    """
    Save input data and output data of a particular layer over calibration dataset.

    :param model: QuantModel
    :param layer: QuantModule
